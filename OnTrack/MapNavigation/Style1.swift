...
public class ResumeButton: UIControl {
    ...
    let imageView = UIImageView(image: UIImage(named: "location")) //UIImageView(image: UIImage(named: "location", in: .mapboxNavigation, compatibleWith: nil)!.withRenderingMode(.alwaysTemplate))
