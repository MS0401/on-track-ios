...
public protocol UserCourseView1 {
    /**
...
public class UserPuckCourseView1: UIView, UserCourseView1 {
    ...
    var puckView: UserPuckStyleKitView1!
    ...
    func commonInit() {
        puckView = UserPuckStyleKitView1(frame: bounds)
...
class UserPuckStyleKitView1: UIView {
