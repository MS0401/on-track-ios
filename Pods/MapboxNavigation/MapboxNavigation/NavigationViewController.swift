...
extension NavigationViewController: RouteControllerDelegate {
    ...
    public func routeController(_ routeController: RouteController, didArriveAt waypoint: Waypoint) {
        ...
        showsEndOfRouteFeedback ? self.mapViewController?.hideEndOfRoute(completion: completion) : noEndOfRouteShow() //self.mapViewController?.showEndOfRoute( completion: completion) : noEndOfRouteShow()
    }
}
